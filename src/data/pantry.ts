...
export interface Sku {
  ...
  perishableDays?: number; // if set: typical shelf life once opened/purchased; absent = shelf-stable
}
...
export const PANTRY: Sku[] = [
  ...
  { item: 'Bread', aisle: 'Grains & staples', packLabel: 'loaf', packPrice: 2.8, packServings: 10, perishableDays: 7 },
  { item: 'Tortilla', aisle: 'Grains & staples', packLabel: '10-pack', packPrice: 2.8, packServings: 10, perishableDays: 7 },
  { item: 'Tortillas', aisle: 'Grains & staples', packLabel: '10-pack', packPrice: 2.8, packServings: 10, perishableDays: 7 },
  { item: 'Corn tortillas', aisle: 'Grains & staples', packLabel: '20-pack', packPrice: 2.4, packServings: 10, perishableDays: 7 },
  ...
  { item: 'Firm tofu', aisle: 'Protein & beans', packLabel: '14 oz block', packPrice: 2.6, packServings: 3, perishableDays: 5 },
  { item: 'Tofu', aisle: 'Protein & beans', packLabel: '14 oz block', packPrice: 2.6, packServings: 3, perishableDays: 5 },
  ...
  { item: 'Banana', aisle: 'Produce', packLabel: 'each', packPrice: 0.25, packServings: 1, perishableDays: 5 },
  { item: 'Apple', aisle: 'Produce', packLabel: 'each', packPrice: 0.35, packServings: 1, perishableDays: 10 },
  ...
  { item: 'Cabbage slaw', aisle: 'Produce', packLabel: 'bag', packPrice: 3.5, packServings: 4, perishableDays: 5 },
  ...
  { item: 'Bell peppers', aisle: 'Produce', packLabel: '3-pack', packPrice: 3.0, packServings: 3, perishableDays: 7 },
  { item: 'Greens', aisle: 'Produce', packLabel: 'bunch', packPrice: 2.3, packServings: 2, perishableDays: 4 },
  ...
  { item: 'Plain yogurt', aisle: 'Dairy & eggs', packLabel: '32 oz tub', packPrice: 4.0, packServings: 6, perishableDays: 10 },
  { item: 'Cheese', aisle: 'Dairy & eggs', packLabel: '8 oz block', packPrice: 3.4, packServings: 5 },
  { item: 'Cottage cheese', aisle: 'Dairy & eggs', packLabel: '16 oz tub', packPrice: 3.6, packServings: 4, perishableDays: 10 },
  { item: 'Soy milk', aisle: 'Dairy & eggs', packLabel: 'half gallon', packPrice: 3.2, packServings: 8, perishableDays: 7 },
